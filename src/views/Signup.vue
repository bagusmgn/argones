<template>
  ...
  <main class="main-content mt-0">
    <div
      class="page-header align-items-start min-vh-25 pt-5 pb-11 m-3 border-radius-lg">
    </div>
    <div class="container">
        ...
        <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
          <div class="card z-index-0">
            ...
            <div class="card-body">
              <form role="form">
                <div class="mb-3">
                  <input class="form-control" v-model="name" type="text" placeholder="Name" aria-label="Name" />
                </div>
                <div class="mb-3">
                  <input class="form-control" v-model="email" type="email" placeholder="Email" aria-label="Email" />
                </div>
                <div class="mb-3">
                  <input class="form-control" v-model="password" type="password" placeholder="Password" aria-label="Password" />
                </div>
                ...
                <div class="text-center">
                  ...
                  @click.prevent="register">Sign up</argon-button>
                </div>
    ...
    register() {
          ...
          data.append('password', this.password)
            ...
            axios.post('http://localhost:8000/api/register', data).then(() => {
              this.$store.commit('setSuccessState', true)
                //redirect ke Sign In
